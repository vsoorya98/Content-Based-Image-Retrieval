...
Once you entered the above mentioned command, it will ask the type of feature extraction you want to perform as mentioned below

EXPECTED OUTPUT :
Enter the type of feature extraction process you want 
A : Center 50*50 as a first Histogram and whole image RGB as second histogram 
...
Task 5: Enter 'A' or 'a' to perform Center 50*50 as a first Histogram and whole image RGB as second histogram 

Extension: Enter 'D' or 'd' to perform Triple Histogram matching 


Note: I am not using any time travel days